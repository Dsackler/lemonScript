...
const semanticChecks = [
  ...
  [
    "complex Dictionary initialization",
    '<slice[], <pulp,taste>> x = {[1,2]: {"hi": sour}, [3,4]: {"bye": sweet}}',
  ],
  [
    "super complex initialization",
    '<<slice[], <taste, pulp>>, <pulp[][],taste>> x = {{[1,2]: {sour: "hi"}}: {[["cool", "story"], ["bro"]]: sweet}}',
  ],
  ["initialize with empty array", "slice[] a = []"],
  ["Array member initialization check", "slice[] x = [] x[0] = 2 "],
  ["Variable declaration to an Array member", "slice[] x = [1] slice y = x[0] "],
  ...
  [
    "complex parameters",
    "When life gives you lemons try noLemon f( <slice[], <pulp,taste>> x ) BEGIN JUICING  END JUICING",
  ],
  ["increment and decrement", "slice x = 10 x-- x++ x+=2"],
  [
    "short return",
    "When life gives you lemons try noLemon helloWorld() BEGIN JUICING you get lemonade and END JUICING",
  ],
  [
    "long return",
    "When life gives you lemons try taste tralse() BEGIN JUICING you get lemonade and sweet END JUICING",
  ],
  [
    "return in nested if",
