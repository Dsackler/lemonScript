...
////(TODO)["long return", "When life gives you lemons try taste tralse() BEGIN JUICING you get lemonade and sweet END JUICING"],
////(TODO)["return in nested if", "When life gives you lemons try slice return10(slice a) BEGIN JUICING Squeeze the lemon if(a == 10) BEGIN JUICING you get lemonade and a END JUICING END JUICING"],
...
////(TODO)["long if", "Squeeze the lemon if(x == 10) BEGIN JUICING pour(“Number is 10”) END JUICING Toss the lemon and do BEGIN JUICING pour(“Number is not 10 or 20”) END JUICING"],
////(TODO)["else if", "Squeeze the lemon if(x == 10) BEGIN JUICING pour(“Number is 10”) END JUICING Keep juicing if(x == 20) BEGIN JUICING pour(“Number is 10”) END JUICING Toss the lemon and do BEGIN JUICING pour(“Number is not 10 or 20”) END JUICING"],
////(TODO)["for with args", "forEachLemon (slice i = 0; i < 5; i++) BEGIN JUICING pour(“Number: ” + i) END JUICING"],
//    ["||", "pour(sweet||1<2||sour||3>4)"],
////(TODO)["&&", "pour(sweet&&1<2&&sour&&!3>4)"],
//    ["relations", 'pour(10 < 20)'],
////(TODO)["arithmetic", "slice x x = 4 slice y = 2 slice z = 1 pour(x + y - - z ^ y % x / y)"],
