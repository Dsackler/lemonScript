...
const forShort = new ast.ForStatement(forArgs, new ast.PrintStatement("i"))
const loopUnrollingShort = [new ast.PrintStatement("0"), new ast.PrintStatement("1"), new ast.PrintStatement("2")]
